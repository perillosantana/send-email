...
Handlebars.registerHelper('replace', function(value, searchVl, newVl) { return value.toString().replace(searchVl, newVl); });
Handlebars.registerHelper('multiplyCurrency', function(value1, value2) { return _formatCurrency(value1 * value2); });
Handlebars.registerHelper('hasSubStr', function(value, search, options) { if (value.toString().indexOf(search) !== -1) { return options.fn(this); } else { return options.inverse(this); }});
